        ...
        <table className="min-w-full bg-white border border-gray-200">
          <thead>
            <tr>
              ...
              <th className="py-3 px-6 bg-gray-100 font-bold uppercase text-sm text-gray-600 border-b">Nombre</th>
              <th className="py-3 px-6 bg-gray-100 font-bold uppercase text-sm text-gray-600 border-b">Correo</th>
              <th className="py-3 px-6 bg-gray-100 font-bold uppercase text-sm text-gray-600 border-b">Contraseña</th>
          ...
          <tbody>
            {usuarios.map((usuario) => (
              <tr key={usuario.id}>
                ...
                <td className="py-4 px-6 border-b">{usuario.password.substring(0, 30)}...</td>
