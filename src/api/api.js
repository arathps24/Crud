const API3 = "http://82.165.213.152:3000/api/admin";
...
const API2 = "http://82.165.213.152:3000/api/admin/login";
...
const API = "http://82.165.213.152:3000/api/producto";
...
const API4 = "http://82.165.213.152:3000/api/usuario";
...
///------------------------Ventas------------------------------------
const API5 = "http://82.165.213.152:3000/car/ventas";
...
const API6 = "http://82.165.213.152:3000/api/cambio-password";
...
const API7 = "http://82.165.213.152:3000/api/usuario-token";
...
/////////---------------------Mostrar Pedidos
const API8 = "http://82.165.213.152:3000/car/pedidos";
